...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_root', type=str, default='NewData/DataAugmentation_Confirm',
                        help='directory of audio files in total duration')
    parser.add_argument('--dst_root', type=str, default='NewData/cleanDataAugmentation_Confirm',
