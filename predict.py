...
class SWHear(object):
    ...
    def __init__(self,device=None,startStreaming=True):
        ...
        self.tape=np.empty(self.rate*self.tapeLength)*np.nan #ตัวแปรที่เก็บ input microphone
        # Help Model
    ...
    # ฟังก์ชันที่ใช้อ่านค่า microphone
    ...
    # ฟังก์ชันที่ใช้เก็บอินพุตเรื่อย ๆ โดยมีขนาดเท่ากับ input ของโมเดล(32000)
    def tape_add(self):
        while True:
